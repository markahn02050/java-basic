...
public class Warrior {
	...
	// 체력20, 마나10, 레벨1, 공격력 3, 방어력, 경험치0이 대입되도록 처리해주세요.
	...
	// 사냥결과 체력이 x이 되었고, 누적 경험치는 y입니다. 라고 출력합니다.
	// 생성자를 비롯한 메서드는 행동을 나타내고
	// 이런 행동의 성공/실패 여부는 오로지 정보(변수)에 의해 결정되며
	// 시도 자체에 대해서는 제한을 두지 않습니ㅏㄷ.
	public void hunt() {
		...
		System.out.println("사냥결과 체력이 " + hp + "가 되었고, 누적 경험치는 " + exp + "입니다.");
